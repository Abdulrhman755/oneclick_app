...
class MainSafesView extends GetView<MainSafesController> {
  const MainSafesView({super.key});
    ...
    return SingleChildScrollView(
      ...
      child: Table(
        ...
        columnWidths: const {
          ...
          1: FixedColumnWidth(120.0), // اسم الخزينه
          2: FixedColumnWidth(100.0), // الفرع
          3: FixedColumnWidth(120.0), // الرصيد الافتتاحي
        },
        ...
        children: [
          ...
          TableRow(
            ...
            children: [
              ...
              buildHeaderCell('اسم الخزينه', headerStyle),
              buildHeaderCell('الفرع', headerStyle),
              buildHeaderCell('الرصيد الافتتاحي', headerStyle),
            ],
          ),
